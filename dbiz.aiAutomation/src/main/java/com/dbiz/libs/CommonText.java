...
public class CommonText {
    ...
    public static String homepageblendingartP_Text="Digital solutions aren’t about engineering alone. We believe in equal parts smarts and creativity, in everything we do.";
    ...
    public static String experiencedesgn_Text="Human-centered solutions, driven by and based on qualitative and quantitative data, ensuring efficient solving of any challenges the business might face.";
    public static String digitalmarketing_Text="Driving online success through innovative solutions tailored to today’s dynamic market landscape";
